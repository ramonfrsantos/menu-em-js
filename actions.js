...
(function() {
  ...
  // Adiciona uma class ao elemento
  mobile.className = 'nav-mobile';

  //Põe a nova tag no código-fonte
  document.querySelector('.nav').appendChild(mobile);

  // Seleciona a nav-mobile
  var mobileNav = document.querySelector('.nav-mobile');
  
  // Seleciona a nav-list
...
})(); // Enquanto o documento não for carregado, nenhuma ação é realizada
